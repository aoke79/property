...
<div class="page">
   <div class="pageContent">
      <form method="post" action="sec-bphase/sec-bphase!editSave.do" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
	     <div class="pageFormContent" layoutH="56">
	     <input type="hidden" name="secBphase.id" value="${secBphase.id}" />
         <p>
		    <label><s:property value="getText('description')"/>:</label>
			<input align="left" name="secBphase.phdesc" type="text" size="30" value="${secBphase.phdesc}" />
		 </p>
		 </div>
		 <div class="formBar">
				<ul>
