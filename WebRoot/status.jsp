...
<body>
<%
double total = Math.rint((Runtime.getRuntime().totalMemory()) / (1024.0 * 1024));
double max = Math.rint((Runtime.getRuntime().maxMemory()) / (1024.0 * 1024));
double free = Math.rint((Runtime.getRuntime().freeMemory()) / (1024.0 * 1024));
out.println("JVM的最大可用内存: " + max + "MB<br/>");
