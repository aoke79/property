...
<div id="addAuthoritJsp" class="page">
	<div class="pageContent">
		<form method="post" action="standard!doSave.do" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
		 ...
		 <input type="hidden" name="username" value="${session.user.username}"/>
			<div class="pageFormContent" layoutH="56">
				<table class="blockPanelTable" cellpadding="0" cellspacing="0" style="width: 98%">
					<tr >
