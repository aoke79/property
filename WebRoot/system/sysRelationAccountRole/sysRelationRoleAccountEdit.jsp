...
<div class="page">
   <div class="pageContent">
      <form method="post" action="sys-relation-account-role/sys-relation-role-account!roleUserEdit.do" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
