...
$(function(){
	$("button[flag=sinoframe]").click(function(){
		$.post(
			"clear-page-num.do",
			function(data){
				if(!data.ok){
...
<div class="page">
	<div class="pageContent">
		<form method="post"
			action="sys-user-group/sys-user-group!addUserToGroup.do"
			...
			<div class="pageFormContent" layoutH="56">
				<div id="wrapping">
						...
						<table>
							<tr><td height="20px">请选择用户：</td></tr>
							<tr>
								<td rowspan="10">
									<s:select list="listTbUser" size="10" listKey="userId" listValue="name" id="select1" cssStyle="height: 250px; width: 180px;" multiple="true" name="default"></s:select>
								</td>
								<td rowspan="10">
									<div id="div2">
								...
								<td>
								<s:select list="sysUserGroup.setCmUser" size="10" listKey="userId" listValue="name" id="select2" cssStyle="height: 250px; width: 180px;" name="ids" multiple="true"></s:select>
								</td>
							</tr>
						</table>
					</div>
							...
							<li>
								<div class="buttonActive">
									<div class="buttonContent">
										<button type="submit" onclick='selectAll($("#select2"))' flag="sinoframe">
											保存
										</button>
									</div>
								</div>
