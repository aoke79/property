...
<script type="text/javascript">
	$(function(){
		getMessageCount();
		//重置
		$("button[cape=reset]").click(function(){
...
<div class="page">
	<div class="pageHeader">
		<form id="pagerForm" onsubmit="return navTabSearch(this);" action="sys-message/unread-message!unreadMessage.do" method="post">
			...
			<c:forEach items="${commonList}" var="commonMessage">
				<tr target="sid_user" rel="${commonMessage.messageId}" >
					...
					<td style="text-align: right;">
						<a class="btnDel" href="sys-message/unread-message!delete.do?method=remove&${commonMessage.messageSource}.id=${commonMessage.messageId}" target="navTabTodo" title="<s:property value='getText("deleteTips")'/>"></a>
						<a class="btnView" href="sys-message/unread-message!view.do?${commonMessage.messageSource}.id=${commonMessage.messageId}" target="navTab" title="<s:property value='getText("messageContent")'/>"></a>
