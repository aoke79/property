...
<jsp:forward page="<%=exporterFilePath%>">
   <jsp:param name="wordjsp" value="/sms/bioscenter/fcexporter/ExcelPic.jsp"/>
</jsp:forward>
<%
	} else if (exportFormat.equals("PNG")) {
%>
<jsp:forward page="<%=exporterFilePath%>">
   <jsp:param name="wordjsp" value="/sms/bioscenter/fcexporter/WordPic.jsp"/>
</jsp:forward>
<%
   } else if (exportFormat.equals("JPG")) {
%>
<jsp:forward page="<%=exporterFilePath%>">
   <jsp:param name="wordjsp" value="/sms/bioscenter/fcexporter/imageShow.jsp"/>
</jsp:forward>
<% }}else {/* exception*/}%>
