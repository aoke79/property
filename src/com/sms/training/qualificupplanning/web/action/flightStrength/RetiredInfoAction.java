...
public class RetiredInfoAction extends BaseAction{
	...
	String strc = "";
	//SHEET 名称
	public String sheetName="年度退役情况";  //不同的页面名称 就修改下
	//EXCEL路径
	public String path = "E:\\e\\年度退役情况.xls";
	...
	public  String flightStrengthOut(){
		...
		System.out.println("");
			...
			for(int i=0 ;i<flightStrengthList.size();i++){
				...
				jxlUtil.writeExcel(Integer.valueOf(fs.getF1()),hang,7);
				jxlUtil.writeExcel(Integer.valueOf(fs.getF2()),hang,8);
				jxlUtil.writeExcel(Integer.valueOf(fs.getF3()),hang,9);
				jxlUtil.writeExcel(Integer.valueOf(fs.getF4()),hang,10);
				jxlUtil.writeExcel(Integer.valueOf(fs.getF5()),hang,11);
