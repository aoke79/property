...
@Entity
@Table(name=" MO_UP_IN")
public class MonthlyIntroduction implements java.io.Serializable{
	...
	@Column(name = "UP_INID", unique = true, nullable = false, insertable = true, updatable = true, length = 36)
