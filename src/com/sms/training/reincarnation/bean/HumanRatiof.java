...
@Entity
@Table(name="MO_UP_FRATE")
public class HumanRatiof implements java.io.Serializable{
	...
	@Column(name = "UP_FRATEID", unique = true, nullable = false, insertable = true, updatable = true, length = 36)
