 ...
 * @author LUJIE
 */
public class CopyOfOutputNewEmployeesAction extends BaseAction {
	...
	public String toadd() {
		try{   
			String cb = " from CompanyInfo where 1=1 ";
			this.companyInfoList = this.cmUserBS.findPageByQuery(cb);
			cs += companyInfoList.size();
			
			List<OutputNewEmployees> ou = new ArrayList<OutputNewEmployees>();
			
			String hqls = "from OutputNewEmployees where 1=1  ";
			 this.outputNewEmployeesList = this.cmUserBS.findPageByQuery(hqls);
			getUserList();
			...
			for(OutputNewEmployees o : outputNewEmployeesList){
				  ...
				  NewEmployees ne= null;
				  if( n !=null  && n.size() !=0){
					  int i = 0;
					  for(NewEmployees c:  n){
						  if(ne.getNews()!=null) i += c.getNews();
					  }
					  o.setYcs(i);
				  }else{
					  o.setYcs(0);
				...
				if(o.getDeptid() != null){
					CompanyInfo c = this.cmUserBS.findById(CompanyInfo.class, o.getDeptid());
					if(c != null){
						if(c.getDeptname().indexOf("总队") != -1){
						   o.setZd(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("西南") != -1){
						   o.setXn(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("浙江") != -1){
						   o.setZj(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("重庆") != -1){
						   o.setCq(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("天津") != -1){
						   o.setTj(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("上海") != -1){
						   o.setSh(o.getNumnewout());
						}
						if(c.getDeptname().indexOf("湖北") != -1){
						   o.setHb(o.getNumnewout());
						}
					}
				}
				ou.add(o);
			...
			List<OutputNewEmployees> ous = ou;
			
		    for(OutputNewEmployees o : ou){
		    	
			    for(OutputNewEmployees o1 : ous){
			    	 if(o1.getYear() != null && o1.getYear().equals(o.getYear())){
			    		 int i = ous.indexOf(o1);
						  if(o.getZd() != null && !"".equals(o.getZd())){
							  o1.setZd(o.getZd());
						  }
						  if(o.getXn() != null && !"".equals(o.getXn())){
							  o1.setXn(o.getXn());
						  }
						  if(o.getZj() != null && !"".equals(o.getZj())){
							  o1.setZj(o.getZj());
						  }
						  if(o.getCq() != null && !"".equals(o.getCq())){
							  o1.setCq(o.getCq());
						  }
						  if(o.getTj() != null && !"".equals(o.getTj())){
							  o1.setTj(o.getTj());
						  }
						  if(o.getSh() != null && !"".equals(o.getSh())){
							  o1.setSh(o.getSh());
						  }
						  if(o.getHb() != null && !"".equals(o.getHb())){
							  o1.setHb(o.getHb());
						  }
			    		  ous.set(i,o1);
			    	 }
	        ...
	        String str = "";
	        List<OutputNewEmployees> one = new ArrayList<OutputNewEmployees>();
	        for(OutputNewEmployees  c : ous){
	        	if(str.indexOf(String.valueOf(c.getYear())) ==-1){
	        		int hj =0;
	        		if(c.getHb() != null)hj+=c.getHb();
	        		
	        		if(c.getXn() != null)hj+=c.getXn();
	        		
	        		if(c.getZd() != null)hj+=c.getZd();
	        		
	        		if(c.getZj() != null)hj+=c.getZj();
	        		
	        		if(c.getTj() != null)hj+=c.getTj();
	        		
	        		if(c.getSh()!= null)hj+=c.getSh();
	        		
	        		if(c.getSh()!= null)hj+=c.getCq();
	        		
	        		c.setHj(hj);
	        		c.setYc(c.getYcs()-c.getHj());
			...
			this.outputNewEmployeesList = one;
		}catch(Exception e){
			e.printStackTrace();
		}
